...
import seaborn
def parse_arg():
    parser = argparse.ArgumentParser(description='This is a program to plot each CV as time, python plot_eachCV.py -infiledir ./ -num_iter 100 -num_walkers 12 -cv_index 8 -time_len 2 -outfile CV8.png')
