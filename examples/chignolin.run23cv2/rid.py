...
enhc_files=["plumed.dat", "plumed.bf.dat", "test.std.py","chig.pdb"]
enhc_plm="plumed.dat"
...
def make_enhc (iter_index, 
    ...
    init_lower_wall_hb = jdata["lower_wall_hb"]
    init_lower_wall_hc = jdata["lower_wall_hc"]
...
##################################
    lower_wall_hb_list=np.zeros(numb_walkers)
    lower_wall_hb_list[0]=float(init_lower_wall_hb)
    lower_wall_hb_list[np.mod(numb_walkers//4,numb_walkers)]=float(init_lower_wall_hb)
    lower_wall_hb_list[np.mod(numb_walkers*2//4,numb_walkers)]=float(init_lower_wall_hb)

    lower_wall_hc_list=np.zeros(numb_walkers)
    lower_wall_hc_list[1]=float(init_lower_wall_hc)
    lower_wall_hc_list[np.mod(numb_walkers//4+1,numb_walkers)]=float(init_lower_wall_hc)
    lower_wall_hc_list[np.mod(numb_walkers*2//4+1,numb_walkers)]=float(init_lower_wall_hc)
    ...
    for walker_idx in range (numb_walkers) :
        ...
        lower_wall_hb=lower_wall_hb_list[walker_idx]
        lower_wall_hc=lower_wall_hc_list[walker_idx]
...
###########################################
            ...
            if num_of_cluster < num_of_cluster_threshhold:
                ...
                enhc_trust_lvl_1 = jdata["bias_trust_lvl_1"]
                enhc_trust_lvl_2 = enhc_trust_lvl_1+1
            if enhc_trust_lvl_1>jdata["bias_trust_lvl_1"]*10:
                enhc_trust_lvl_1 = jdata["bias_trust_lvl_1"]
                enhc_trust_lvl_2 = enhc_trust_lvl_1+1
            lower_wall_hb=lower_wall_hb_list[np.mod(walker_idx+iter_index,numb_walkers)]
            lower_wall_hc=lower_wall_hc_list[np.mod(walker_idx+iter_index,numb_walkers)]
        ...
        replace(plm_conf, "LOWER_WALLS ARG=hb AT=[^ ]* ", ("LOWER_WALLS ARG=hb AT=%f " %lower_wall_hb))
        replace(plm_conf, "LOWER_WALLS ARG=hc AT=[^ ]* ", ("LOWER_WALLS ARG=hc AT=%f " %lower_wall_hc))
        ...
        replace(plm_bf_conf, "LOWER_WALLS ARG=hb AT=[^ ]* ", ("LOWER_WALLS ARG=hb AT=%f " %lower_wall_hb))
        replace(plm_bf_conf, "LOWER_WALLS ARG=hc AT=[^ ]* ", ("LOWER_WALLS ARG=hc AT=%f " %lower_wall_hc))
