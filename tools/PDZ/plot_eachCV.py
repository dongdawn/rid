...
def parse_arg():
    parser = argparse.ArgumentParser(description='This is a program to plot each CV as time, python plot_eachCV.py -infiledir "/home/wdd/reinforcedMD/deep.fe/source/ala-n_test/out/" -num_iter 100 -num_walkers 30 -cv_index 1 -time_len 100 -outfile "CV1.png"')
